...
| `vX.Y.Z-rc.N`, `-alpha.N`, `-beta.N` | Pre-release | GitHub pre-release |
...
6. `.github/workflows/release.yml` builds, publishes to PyPI, and creates
...
Code is GPL-3.0-or-later, documentation is CC BY 4.0 — see
